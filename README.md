...
11. Used Mokito and Koin for unit testing. I wrote 3 unit tests to check error, empty and list of data cases (In [koin-di](https://github.com/yourappsgeek/Sixt-android-coding-challenge/tree/koin-di) branch).

12. Used Coroutines-test for unit testing. I wrote 3 unit tests to check error, empty and list of data cases (In [Coroutines-test](https://github.com/yourappsgeek/Sixt-android-coding-challenge/tree/Coroutines-test) branch).
